/* ──────────────────────────────────────────────────────────────
   Xperion Demo — SQLite database layer (file: data/tap.db)
...
/* Data location is env-overridable so a second deployment (different port,
   different folder) never shares a database file with another instance.
   DB_PATH wins outright; otherwise DATA_DIR + DB_FILE; otherwise ./data/mar.db */
...
const DB_PATH = process.env.DB_PATH
  ...
  : path.join(DATA_DIR, process.env.DB_FILE || "mar.db");
...
const PERSONAS = {
  ...
  lars: {
    ...
    synced: { origin: "FRA", dest: "JFK", date: "2026-07-08", device: "ThinkPad", stage: "review", flight_no: "XP211", seat: "2A", items: ["bag","meal","lounge"], cabin: "Business" },
    ancillaries: [
    ...
    history: [
      ["XP211","FRA→JFK","2026-02-04","10:40","Business"],["XP212","JFK→FRA","2026-02-09","18:20","Business"],
      ["XP211","FRA→JFK","2026-03-03","10:40","Business"],["XP212","JFK→FRA","2026-03-07","18:20","Business"],
      ["XP8050","FRA→GRU","2026-03-20","21:50","Business"],["XP8051","GRU→FRA","2026-03-27","19:10","Business"],
      ["XP211","FRA→JFK","2026-04-08","10:40","Business"],["XP212","JFK→FRA","2026-04-13","18:20","Business"],
      ["XP211","FRA→JFK","2026-05-06","10:40","Business"],["XP212","JFK→FRA","2026-05-11","18:20","Business"],
      ["XP8050","FRA→GRU","2026-05-19","21:50","Business"],["XP8051","GRU→FRA","2026-05-26","19:10","Business"],
      ["XP211","FRA→JFK","2026-06-03","10:40","Business"],["XP212","JFK→FRA","2026-06-08","18:20","Business"],
    ],
    bookings: [
      ["XPL1A2","XP211","FRA","JFK","10:40","13:30",612,"2026-02-04","2A","completed",1,["seat","bag","meal","wifi","lounge"]],
      ["XPL2B3","XP8050","FRA","GRU","21:50","05:20",740,"2026-03-20","2A","completed",1,["seat","bag","meal","wifi","lounge"]],
      ["XPL3C4","XP211","FRA","JFK","10:40","13:30",598,"2026-03-03","2A","completed",1,["seat","bag","meal","wifi","lounge","transfer"]],
      ["XPL4D5","XP211","FRA","JFK","10:40","13:30",625,"2026-04-08","2A","completed",1,["seat","bag","meal","wifi","lounge"]],
      ["XPL5E6","XP211","FRA","JFK","10:40","13:30",610,"2026-05-06","2A","completed",1,["seat","bag","meal","wifi","lounge","transfer"]],
      ["XPL6F7","XP8050","FRA","GRU","21:50","05:20",728,"2026-05-19","2A","completed",1,["seat","bag","meal","wifi","lounge"]],
      ["XPL7G8","XP211","FRA","JFK","10:40","13:30",612,"2026-07-08","2A","confirmed",0,["seat","bag","meal","wifi","lounge"]],
      ["XPL8H9","XP8050","FRA","GRU","21:50","05:20",740,"2026-07-25","2A","confirmed",0,["seat","bag","meal","wifi","lounge"]],
    ],
    searches: [
  ...
  luis: {
    ...
    synced: { origin: "JFK", dest: "BOS", date: "2026-06-18", device: "iPad Pro", stage: "seat", flight_no: "XP205", seat: "1A", items: ["seat", "lounge"], cabin: "Business" },
    ancillaries: [
    ...
    history: [
      ["XP205", "JFK→BOS", "2026-02-14", "10:30", "Business"], ["XP206", "BOS→JFK", "2026-02-20", "19:45", "Business"],
      ["XP205", "JFK→BOS", "2026-03-18", "10:30", "Business"], ["XP206", "BOS→JFK", "2026-03-24", "19:45", "Business"],
      ["XP1360", "JFK→LHR", "2026-04-05", "08:40", "Business"], ["XP1361", "LHR→JFK", "2026-04-08", "20:10", "Business"],
      ["XP205", "JFK→BOS", "2026-05-12", "10:30", "Business"], ["XP206", "BOS→JFK", "2026-05-18", "19:45", "Business"],
    ],
    bookings: [
  ...
  arthur: {
    ...
    history: [
      ["XP206", "BOS→JFK", "2026-03-02", "22:20", "Business"], ["XP205", "JFK→BOS", "2026-03-14", "10:30", "Business"],
      ["XP206", "BOS→JFK", "2026-05-06", "22:20", "Business"], ["XP205", "JFK→BOS", "2026-05-16", "10:30", "Business"],
    ],
    bookings: [
...
function seedUser(uid, personaId) {
  ...
  // synced flight may not be pinned or previously booked (e.g. Sofia's XP1042),
