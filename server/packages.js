...
const PACKAGES = {
  football: (home) => pkg({
    id: "clasico-lisbon",
    affinity: "football",
    badge: "Matchday in Lisbon",
    city: "Lisbon",
    code: "LIS",
    event: "Lisbon derby — league matchday",
    ...
    hotelNights: 3,
    hotelPrice: 310,
    flightDesc: `Return ${home} ⇄ LIS · Economy`,
    flightPrice: 96,
    image: "https://images.unsplash.com/photo-1577223625816-7546f13df25d?auto=format&fit=crop&w=1000&q=80",
    blurb: "You stream every match and your card sees the stadium spend — here's the real thing. Match ticket, 3 nights in the Baixa, and your return flight, one tap.",
    addon: null,
  }),
  golf: (home) => pkg({
    id: "algarve-open",
