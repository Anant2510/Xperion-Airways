...
| Briefs (in-process, mocked internet) | `node _brief-test.mjs` | 58/58 |
| Autonomy (in-process) | `node _autonomy-test.mjs` | 59/59 (51 + 2 restart/hold checks + 6 failure-reply checks; wipes and reseeds the graph, run it alone) |
